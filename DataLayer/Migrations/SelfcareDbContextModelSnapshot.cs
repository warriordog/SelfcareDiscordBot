...
namespace SelfcareBot.DataLayer.Migrations
{
    ...
    internal class SelfcareDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            #pragma warning disable 612, 618
            modelBuilder.HasAnnotation("ProductVersion", "5.0.1");

            modelBuilder.Entity(
                "SelfcareBot.DataLayer.entities.KnownUser",
                b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity(
                "SelfcareBot.DataLayer.entities.UserScore",
                b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
